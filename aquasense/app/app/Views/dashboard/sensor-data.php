...
// Get thresholds from the controller or set defaults
                    ...
                    <?php foreach ($readings as $reading): ?>
                        <tr data-status="<?= strtolower($reading['status'] ?? 'normal') ?>"
                            ...
                            <td class="text-center">
                                ...
                                ?>
                                <span class="badge <?= $tempClass ?>"><?= $tempStatus ?></span>
                            </td>
                            <td class="text-center">
                                <?php 
                                $phStatus = 'Normal';
                                $phClass = 'status-badge';
                                ...
                                ?>
                                <span class="badge <?= $phClass ?>"><?= $phStatus ?></span>
                            </td>
                            <td class="text-center">
                                <?php 
                                $turbidityStatus = 'Normal';
                                $turbidityClass = 'status-badge';
                                if ($reading['turbidity'] > $thresholds['turbidity_max']) {
                                    $turbidityStatus = 'High';
                                    $turbidityClass = 'bg-danger';
                                }
                                ?>
                                <span class="badge <?= $turbidityClass ?>"><?= $turbidityStatus ?></span>
                            </td>
                            <td>
                                <?php 
                                $status = $reading['status'] ?? 'normal';
                                $statusClass = $status === 'warning' ? 'bg-warning' : ($status === 'danger' ? 'bg-danger' : 'status-badge');
